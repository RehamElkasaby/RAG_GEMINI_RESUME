...
from cv_schema_simple import CVData, MatchResult

class SimpleJobMatcher:
    """Simple job description matching system without external dependencies"""
    ...
    def find_matches(
        ...
        for cv_data_dict in cv_data_list:
            try:
                ...
                cv_data = CVData.from_dict(cv_data_dict)
    ...
    def _calculate_skill_match(self, cv_data: CVData, job_requirements: Dict[str, Any]) -> tuple:
        ...
        # Simple text-based similarity for skills not directly matched
    ...
    def _calculate_experience_match(self, cv_data: CVData, job_requirements: Dict[str, Any], job_description: str) -> tuple:
        ...
        for exp in cv_data.experience:
            ...
            relevance_score = 0
            job_words = job_desc_lower.split()
